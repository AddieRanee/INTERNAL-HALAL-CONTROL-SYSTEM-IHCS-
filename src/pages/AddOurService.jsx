// src/pages/AddOurService.jsx
import { useState } from "react";
import { Link, useNavigate } from "react-router-dom";
import IhcsHeader from "../assets/IHCS_header_pic.png";
import IhcsFooter from "../assets/IHCS_Footer_pic.png";
import { Briefcase, PlusCircle, ClipboardCheck } from "lucide-react";

export default function AddOurService({ onLogout }) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Saving Our Service:", serviceInfo);

    setTimeout(() => {
      alert("✅ Our Service information saved!");
      setServiceInfo("");
      setLoading(false);
    }, 800);
  };
      ...
      <main className="flex items-center justify-center flex-1 p-6">
        <div style={cardStyle}>
          ...
          <div style={{ padding: "0 36px", marginTop: "12px" }}>
            <div style={noteStyle}>
              Describe the halal-related services provided by the organization
              for official documentation and public reference.
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={formStyle}>
            ...
            <button
              ...
              disabled={loading || !serviceInfo.trim()}
            >
