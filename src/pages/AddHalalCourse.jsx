// src/pages/AddHalalCourse.jsx
import { useState } from "react";
import { Link, useNavigate } from "react-router-dom";
import IhcsHeader from "../assets/IHCS_header_pic.png";
import IhcsFooter from "../assets/IHCS_Footer_pic.png";
import { BookOpen, PlusCircle, ClipboardCheck } from "lucide-react";

export default function AddHalalCourse({ onLogout }) {
  const navigate = useNavigate();
  const [halalCourse, setHalalCourse] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Saving Halal Course:", halalCourse);

    setTimeout(() => {
      alert("✅ Halal Course information saved!");
      setHalalCourse("");
      setLoading(false);
    }, 800);
  };
      ...
      <main className="flex items-center justify-center flex-1 p-6">
        <div style={cardStyle}>
          ...
          <div style={titleStyle}>
            <BookOpen size={22} />
            Halal Course Information
          </div>

          {/* NOTE */}
          <div style={{ padding: "0 36px", marginTop: "12px" }}>
            <div style={noteStyle}>
              Enter details of halal-related courses offered for training,
              certification, and awareness purposes.
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={formStyle}>
            <label style={labelStyle}>
              ...
              <textarea
                ...
                placeholder="Write halal course details…"
                value={halalCourse}
                onChange={(e) => setHalalCourse(e.target.value)}
                required
              />
            </label>
            ...
            <button
              ...
              disabled={loading || !halalCourse.trim()}
            >
